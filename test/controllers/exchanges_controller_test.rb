...
#       post :create, exchange: { rate: @exchange.rate, trip_id: @exchange.trip_id, type: @exchange.type }
#     end
...
#     patch :update, id: @exchange, exchange: { rate: @exchange.rate, trip_id: @exchange.trip_id, type: @exchange.type }
#     assert_redirected_to exchange_path(assigns(:exchange))
#   end
